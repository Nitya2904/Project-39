...
function preload(){
ground_image=loadImage("Back (2).jpg");
...
ground.velocityX=-0.5
   ...
   girl=createSprite(300,height-70,20,50);
 ...
 // girl.velocityX=2;
  ...
  zombie=createSprite(50,height-70,20,50);
...
zombie.collide(invisible_ground); 
 ...
 if((keyDown("space")&& girl.y >= 220)) {
  ...
  textSize(40);
  textFont("georgia")
  text("Press space to jump over the obstacles:)",displayWidth-100,displayHeight-50);
}
